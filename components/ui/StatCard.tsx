...
export default function StatCard({ icon, label, value }: Props) {
  return (
    <div className="flex flex-col items-start justify-between gap-3 rounded-2xl border border-white/10 bg-[#151517] p-4 shadow-sm focus-visible:outline-none focus-visible:ring-2 ring-white/30">
