    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button
          ...
          className="h-8 w-8 rounded-full overflow-hidden hover:ring-2 hover:ring-purple-400 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-400"
