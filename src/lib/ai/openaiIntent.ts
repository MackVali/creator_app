  ...
  properties: {
    ...
    draft: {
      ...
      properties: {
        ...
        habit_type: {
          type: ["string", "null"],
          enum: ["HABIT", "CHORE", "PRACTICE", "SYNC", null],
        },
        ...
        recurrence_mode: {
          type: ["string", "null"],
          enum: ["DAILY", "WEEKLY", "INTERVAL", null],
        },
        energy: {
          type: ["string", "null"],
          enum: ["NO", "LOW", "MEDIUM", "HIGH", "ULTRA", "EXTREME", null],
        },
        skillId: { type: ["string", "null"] },
        locationContextId: { type: ["string", "null"] },
      },
    },
    suggestion: {
      type: ["object", "null"],
