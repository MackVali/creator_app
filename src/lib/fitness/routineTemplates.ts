  ...
  },
  {
    ...
    routines: [
      routine(
        ...
        45,
        [
          reps("Bench Press", 4, 8, "primary", 90, [6, 10]),
          reps("Incline Bench Press", 3, 10, "primary", 75, [8, 12]),
          reps("Shoulder Press", 3, 10, "secondary", 75, [8, 12]),
          reps("Lateral Raise", 3, 15, "accessory", 45, [12, 20]),
          reps("Cable Fly", 3, 12, "accessory", 45, [10, 15]),
        ],
      ),
      ...
      routine(
        ...
        40,
        [
          reps("Biceps Curl", 3, 10, "primary", 60, [8, 12]),
          reps("Hammer Curl", 3, 10, "primary", 60, [8, 12]),
          reps("Triceps Extension", 3, 12, "primary", 60, [10, 15]),
          reps("Wrist Curl", 3, 15, "accessory", 45, [12, 20]),
          reps("Reverse Wrist Curl", 3, 15, "accessory", 45, [12, 20]),
          reps("Reverse Curl", 3, 12, "accessory", 45, [10, 15]),
          timed("Plate Pinch", 3, 30, "accessory", 45),
        ],
      ),
      ...
      routine(
        ...
        45,
        [
          reps("Bent-Over Row", 4, 8, "primary", 90, [6, 10]),
          reps("Seated Cable Row", 3, 10, "primary", 75, [8, 12]),
          reps("Face Pull", 3, 15, "secondary", 45, [12, 20]),
          reps("Reverse Fly", 3, 12, "secondary", 45, [10, 15]),
          reps("Barbell Shrug", 4, 10, "primary", 75, [8, 12]),
          timed("Farmer's Carry", 3, 40, "accessory", 60),
        ],
      ),
      ...
      routine(
        ...
        45,
        [
          reps("Romanian Deadlift", 4, 8, "primary", 90, [6, 10]),
          reps("Back Extension", 3, 12, "primary", 60, [10, 15]),
          reps("Good Morning", 3, 10, "secondary", 75, [8, 12]),
          reps("Hip Thrust", 4, 10, "secondary", 75, [8, 12]),
          reps("Leg Curl", 3, 12, "accessory", 60, [10, 15]),
        ],
      ),
      ...
      routine(
        ...
        35,
        [
          reps("Cable Crunch", 3, 12, "primary", 45, [10, 15]),
          reps("Hanging Knee Raise", 3, 10, "primary", 60, [8, 15]),
          reps("Russian Twist", 3, 16, "primary", 45, [12, 20]),
          reps("Cable Wood Chop", 3, 12, "primary", 45, [10, 15]),
          reps("Pallof Press", 3, 10, "secondary", 45, [8, 12]),
          timed("Suitcase Carry", 3, 30, "secondary", 45),
          timed("Side Plank", 3, 30, "accessory", 45),
        ],
      ),
      ...
      routine(
        ...
        50,
        [
          reps("Front Squat", 4, 8, "primary", 90, [6, 10]),
          reps("Leg Press", 4, 10, "primary", 75, [8, 12]),
          reps("Leg Extension", 3, 12, "secondary", 60, [10, 15]),
          reps("Adductor Machine", 4, 12, "primary", 60, [10, 15]),
          reps("Sumo Squat", 3, 10, "primary", 75, [8, 12]),
          reps("Copenhagen Plank", 3, 10, "accessory", 45, [8, 12]),
        ],
      ),
      ...
      routine(
        ...
        45,
        [
          reps("Hip Thrust", 4, 10, "primary", 75, [8, 12]),
          reps("Romanian Deadlift", 4, 8, "primary", 90, [6, 10]),
          reps("Lying Leg Curl", 3, 12, "primary", 60, [10, 15]),
          reps("Bulgarian Split Squat", 3, 10, "secondary", 60, [8, 12]),
          reps("Glute Bridge", 3, 12, "accessory", 45, [10, 15]),
        ],
      ),
      ...
      routine(
        ...
        30,
        [
          reps("Standing Calf Raise", 4, 15, "primary", 60, [12, 20]),
          reps("Seated Calf Raise", 4, 15, "primary", 60, [12, 20]),
          reps("Single Leg Calf Raise", 3, 12, "secondary", 45, [10, 20]),
          reps("Tibialis Raise", 4, 15, "primary", 45, [12, 20]),
          reps("Toe Raise", 3, 15, "secondary", 45, [12, 20]),
        ],
      ),
      ...
      routine(
        ...
        20,
        [
          reps("Neck Flexion", 3, 15, "primary", 45, [12, 20]),
          reps("Neck Extension", 3, 15, "primary", 45, [12, 20]),
          reps("Neck Lateral Flexion", 3, 12, "primary", 45, [10, 15]),
        ],
      ),
    ],
  },
