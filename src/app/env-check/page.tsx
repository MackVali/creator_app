      ...
      <div className="space-y-6">
        <div className="p-6 bg-zinc-900/40 rounded-2xl border border-zinc-800/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-zinc-800/40 rounded-lg">
              <div className="text-sm text-zinc-400 mb-2">NEXT_PUBLIC_SUPABASE_URL</div>
              <div className="text-lg font-mono">
                {envInfo.NEXT_PUBLIC_SUPABASE_URL.present ? '✅ Present' : '❌ Missing'}
              </div>
            ...
            <div className="p-4 bg-zinc-800/40 rounded-lg">
              <div className="text-sm text-zinc-400 mb-2">NEXT_PUBLIC_SUPABASE_ANON_KEY</div>
              <div className="text-lg font-mono">
                {envInfo.NEXT_PUBLIC_SUPABASE_ANON_KEY.present ? '✅ Present' : '❌ Missing'}
              </div>
              <div className="text-sm text-zinc-300">
        ...
        <div className="p-6 bg-zinc-900/40 rounded-2xl border border-zinc-800/70">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 bg-zinc-800/40 rounded-lg">
              <div className="text-sm text-zinc-400 mb-2">NEXT_PUBLIC_VERCEL_ENV</div>
              <div className="text-lg font-mono">{envInfo.NEXT_PUBLIC_VERCEL_ENV}</div>
            </div>
          </div>
        </div>
