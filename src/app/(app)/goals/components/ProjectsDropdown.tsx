    ...
    >
      <div className="space-y-4 text-sm text-white/70">
        ...
        <button
          ...
          className="mt-3 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/[0.06] px-4 py-2 text-xs font-semibold uppercase tracking-[0.3em] text-white/70 transition hover:border-white/40 hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
        >
          {addingProject ? "Adding project" : "Add a new project"}
          <span
            aria-hidden
            className="h-px w-8 bg-gradient-to-r from-transparent via-white/60 to-transparent"
          />
        </button>
      </div>
    </div>
