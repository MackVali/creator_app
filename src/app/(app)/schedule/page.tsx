...
export default function SchedulePage() {
  ...
  const [currentDate, setCurrentDate] = useState(() => initialDateResult.date);
  ...
  const [scheduledProjectIds, setScheduledProjectIds] = useState<Set<string>>(
    new Set()
  );
            ...
            {modelHabitPlacements.map((placement, index) => {
              ...
              if (isHabitCompleted) {
                if (viewIsFutureDay) {
                  ...
                  const placementIsBeforeNow =
                    placement.end.getTime() <= currentTimeMs;
              ...
              return (
                <motion.div
                  ...
                  style={{ ...layeredCardStyle, touchAction: "manipulation" }}
