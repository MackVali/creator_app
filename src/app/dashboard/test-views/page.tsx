    ...
    <div className="mx-auto max-w-4xl p-6 md:p-10 text-zinc-100">
      ...
      <div className={`mb-8 p-6 rounded-2xl border ${
        ...
        <div className="grid grid-cols-3 gap-4 text-sm">
          ...
          <div>
            ...
            <div className="text-2xl font-bold text-green-400">{results.passedTests}</div>
          </div>
          <div>
            <div className="text-zinc-400">Failed</div>
            <div className="text-2xl font-bold text-red-400">{results.failedTests}</div>
          </div>
        </div>
      </div>
          ...
          >
            ...
            {result.error && (
              <div className="mt-4 p-4 bg-red-900/40 rounded-lg border border-red-500/30">
                ...
                <div className="font-mono text-sm text-red-200">{result.error}</div>
              </div>
            )}

            {result.sampleData && (
              <div className="mt-4 p-4 bg-zinc-800/40 rounded-lg border border-zinc-600/30">
                <div className="text-zinc-300 font-semibold mb-2">Sample Data:</div>
      ...
      <div className="mt-8 p-6 bg-zinc-800/40 rounded-2xl border border-zinc-600/30">
        ...
        <ul className="space-y-2 text-sm text-zinc-300">
          <li>• <strong>RLS Policies:</strong> Verifies users can only access their own data</li>
          <li>• <strong>View Permissions:</strong> Confirms SELECT access works for authenticated users</li>
          <li>• <strong>Data Structure:</strong> Validates views return expected columns and data types</li>
          <li>• <strong>Authentication:</strong> Ensures cookie-based auth is working correctly</li>
        </ul>
        
        <div className="mt-4 p-4 bg-blue-900/20 rounded-lg border border-blue-500/30">
          <div className="text-blue-300 text-sm">
            <strong>Note:</strong> This page must be accessed by an authenticated user to properly test RLS policies. 
