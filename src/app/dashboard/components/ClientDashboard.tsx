...
export function ClientDashboard() {
  ...
  if (!data) {
    return (
      <div className="text-zinc-400 p-8">No data available</div>
    )
  }
  ...
  return (
    <div className="p-6">
      ...
      {/* Skills */}
      <div className="mb-6 p-4 bg-zinc-800 rounded-lg">
        <h2 className="text-lg font-semibold mb-2">Skills ({skillsAndGoals.skills.length})</h2>
      ...
      {/* Goals */}
      <div className="mb-6 p-4 bg-zinc-800 rounded-lg">
        <h2 className="text-lg font-semibold mb-2">Goals ({skillsAndGoals.goals.length})</h2>
