    ...
    >
      ...
      >
        <div className="flex w-full min-w-0 flex-col items-center justify-center gap-1.5">
          ...
          {hasChildren ? (
            <span className="max-w-full rounded-full border border-white/[0.08] bg-white/[0.04] px-1.5 py-0.5 text-[8px] font-semibold leading-none text-white/42 sm:text-[9px]">
