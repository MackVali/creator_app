...
export default function ActivityPanel() {
  return (
    <Card className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#101928] via-[#0f1524] to-[#070a13] p-6 shadow-[0_28px_90px_-48px_rgba(10,15,25,0.75)] sm:p-7 text-white gap-0">
